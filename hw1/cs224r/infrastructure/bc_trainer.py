...
class BCTrainer:
    ...
    def collect_training_trajectories(
        ...
        # HINT2: use sample_trajectories from utils
        ...
        if load_initial_expertdata == None:
            paths, envsteps_this_batch = utils.sample_trajectories(self.env, collect_policy, self.params['batch_size_initial'], self.params['ep_len'], False)
        elif itr != 0:
